...
scene.updateMatrixWorld(true);
		...
		// posMatrix.getPositionFromMatrix( tiles[0][1].matrixWorld );
		tilesX = 0;
		tilesY = 8;
		...
		scene.add( spritey );
				...
				var arrowHelper = new THREE.ArrowHelper(direction.normalize(), from, length, 0xbdbdbd,1,1 );

				// arrowHelper.line.material.linewidth = 100;
				scene.add( arrowHelper );
				// alert(tiles[0][0].position.x);
				// alert(tiles[0][0].position.y);
				// tiles[0][0].position.y =1.1;
				// tiles[arrowX][arrowY].position.y = 2;
				// alert(tiles[arrowX][arrowY].po
				
					// alert(posMatrix.x + " " + posMatrix.y + " " + posMatrix.z);
				// alert(tiles[0][1].position.x + " " + tiles[0][1].position.y + " " + tiles[0][1].position.z);
				// alert(tiles[0][0].position.x + " " + tiles[0][0].position.y + " " + tiles[0][0].position.z);
